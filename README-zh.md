...
## 用法
`bash <(wget -qO- https://raw.githubusercontent.com/guowanghushifu/Dedicated-Seedbox/main/Install.sh) -u <用戶名稱> -p <密碼> -c <緩存大小(單位:MiB)> -q <qBittorrent 版本> -l <libtorrent 版本> -b -v -r -3 -x -o`
#### Options
	1. -u: 用戶名稱
	2. -p: 密碼
	...
	11.-o: 自定義端口
#### 範例
`bash <(wget -qO- https://raw.githubusercontent.com/guowanghushifu/Dedicated-Seedbox/main/Install.sh) -u guowanghushifu -p 1LDw39VOgors -c 3072 -q 4.3.9 -l v1.2.19 -v -x`

##### 解釋
	1. 用戶名稱 是 guowanghushifu
	2. 密碼 是 1LDw39VOgors
	3. 緩存大小 是 3GB
